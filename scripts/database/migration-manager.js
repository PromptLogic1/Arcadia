 ...
 *
 * NOTE: When using Claude Code, you can also use the Supabase MCP commands:
 *   - mcp__supabase__apply_migration - for DDL operations
 *   - mcp__supabase__execute_sql - for DML operations
 *   - mcp__supabase__generate_typescript_types - for type generation
 *
 * Usage:
