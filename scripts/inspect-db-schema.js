...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNub3RpdXBkcWJkeHh4anJjcXZiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDgyOTA4ODQsImV4cCI6MjA2Mzg2Njg4NH0.Epy3TVOBekPA-lKxm42-res4SOu-qsoQ833T5eyWAwk';
    ...
    if (tablesError) {
      ...
      if (rpcError) {
        ...
        const commonTableNames = [
          'users', 'bingo_boards', 'bingo_cards', 'bingo_sessions', 
          'bingo_session_players', 'bingo_session_queue', 'bingo_session_events',
          'bingo_session_cells', 'categories', 'challenges', 'submissions',
          'discussions', 'comments', 'tags', 'user_activity'
        ];
