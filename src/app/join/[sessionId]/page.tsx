...
export default function JoinSession({ params }: { params: { sessionId: string } }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4">
      <Card className="w-full max-w-md p-6 bg-gray-800 border-cyan-500/20">
        <h1 className="text-2xl font-bold text-cyan-400 mb-6">Join Bingo Session</h1>
            ...
            {sessionDetails.teamMode && (
              <div className="p-3 bg-cyan-500/10 rounded-lg">
                <p className="text-sm text-cyan-300">
                  This is a team mode session. You&apos;ll be automatically assigned to a team.
                </p>
              </div>
            )}
