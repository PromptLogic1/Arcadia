  ...
  'inline-flex items-center justify-center rounded-lg p-1 transition-all duration-200',
  {
    variants: {
      variant: {
        ...
        cyber: 'bg-slate-900/50 border border-cyan-500/30 backdrop-blur-sm h-10',
...
const tabsTriggerVariants = cva(
  'inline-flex items-center justify-center rounded-md px-3 py-1 text-sm font-medium whitespace-nowrap transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'ring-offset-background focus-visible:ring-ring data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow',
        cyber: 'data-[state=active]:bg-cyan-500/20 data-[state=active]:text-cyan-200 data-[state=active]:border-cyan-400/50 data-[state=active]:shadow-lg data-[state=active]:shadow-cyan-500/30 hover:bg-cyan-500/10 hover:text-cyan-300 text-cyan-300/70',
        ...
        glass: 'data-[state=active]:bg-white/20 data-[state=active]:text-white data-[state=active]:backdrop-blur-sm data-[state=active]:shadow-lg hover:bg-white/10 text-white/70',
        minimal: 'data-[state=active]:text-cyan-400 data-[state=active]:border-b-2 data-[state=active]:border-cyan-400 rounded-none border-b-2 border-transparent hover:text-cyan-300 text-cyan-300/70',
      },
    },
    defaultVariants: {
      variant: 'default',
