...
describe('CyberpunkBackground', () => {
  ...
  describe('variant: grid', () => {
    ...
    test('should apply grid background styles', () => {
      ...
      expect(gridElement?.getAttribute('style')).toContain('rgba(6,182,212,0.05)');
    });
    ...
    test('should have mask image for gradient effect', () => {
      ...
      const gridElement = container.querySelector('[style*="linear-gradient"]');
      expect(gridElement).toHaveClass('[mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]');
    });
  });
  ...
  describe('variant: circuit', () => {
    test('should render circuit variant', () => {
      ...
      const circuitElement = container.querySelector('[style*="linear-gradient"]');
    ...
    test('should apply circuit background styles', () => {
      ...
      expect(circuitElement?.getAttribute('style')).toContain('rgba(6,182,212,0.05)');
    });
  });
  ...
  describe('variant: particles', () => {
    ...
    test('should have overflow-hidden container', () => {
      ...
      expect(particleContainer).toHaveClass('absolute', 'inset-0', 'will-change-transform');
    });
  });
  ...
  describe('intensity prop', () => {
    ...
    test('should apply medium intensity', () => {
      ...
      const gridElement = container.querySelector('[style*="linear-gradient"]');
      expect(gridElement?.getAttribute('style')).toContain('rgba(6,182,212,0.1)');
    });
    ...
    test('intensity should affect circuit variant', () => {
      ...
      const circuitElement = container.querySelector('[style*="linear-gradient"]');
      expect(circuitElement?.getAttribute('style')).toContain('rgba(6,182,212,0.1)');
    });
  });
  ...
  describe('performance optimizations', () => {
    test('should use will-change-transform for GPU acceleration', () => {
      ...
      const transformElement = container.querySelector('.will-change-transform');
  ...
  describe('accessibility', () => {
    test('should support motion-reduce preferences', () => {
      ...
      const animatedElements = container.querySelectorAll('[class*="motion-reduce:animate-none"]');
  ...
  describe('edge cases', () => {
    test('should handle invalid variant gracefully', () => {
      ...
      expect(container.firstChild).toHaveClass('relative');
      const backgroundElements = container.querySelectorAll('[style*="linear-gradient"], .bg-cyan-400\\/20');
