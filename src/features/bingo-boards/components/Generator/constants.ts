...
export const GENERATOR_STYLES = {
  ...
  SELECT_TRIGGER: 'touch-target border-border/30 bg-input/80 hover:bg-input/90 focus:ring-ring user-invalid:border-destructive user-valid:border-green-500',
  SELECT_CONTENT: 'glass border-border/30 bg-popover backdrop-blur-sm',
  SELECT_ITEM: 'touch-target hover:bg-accent/20 focus:bg-accent/20 pointer-coarse:p-3 pointer-fine:p-2',
  
  // Interactive elements with enhanced effects
  BADGE: 'border border-border/30 bg-accent/10 text-accent text-shadow-sm hover-lift',
  BADGE_SELECTED: 'border-accent/50 bg-accent/20 text-accent text-shadow-md drop-shadow-sm drop-shadow-accent/30',
  
  // Buttons with modern gradients and effects
  BUTTON_PRIMARY: 'w-full gradient-primary hover-glow text-primary-foreground font-medium touch-target text-shadow-sm drop-shadow-lg drop-shadow-primary/25',
  BUTTON_SECONDARY: 'touch-target border-border/30 bg-secondary/80 hover:bg-secondary/90 text-secondary-foreground hover-lift',
  ...
  ERROR_CONTAINER: 'mt-4 glass border border-destructive/30 bg-destructive/5 backdrop-blur-sm p-4 text-shadow-sm',
  ...
  LOADING_SPINNER: 'animate-glow text-primary drop-shadow-lg drop-shadow-primary/50',
} as const;
