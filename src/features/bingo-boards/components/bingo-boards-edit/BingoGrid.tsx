 ...
 */
const GridCard = React.memo(function GridCard({ card, index, gridSize, onClick, onRemove }: GridCardProps) {
      ...
      >
        ...
        {isEmpty ? (
          <div className="flex h-full flex-col items-center justify-center p-4 text-center">
            ...
            <p className={cn(typography.caption, 'mt-1')}>or click to select</p>
          </div>
        ) : (
