...
export class ScoringService {
  ...
  calculateScore(
    ...
    return {
      baseScore,
      timeBonus,
      speedMultiplier: timeElapsed < 120 ? this.config.multipliers.speedBonus : 1.0,
      perfectionMultiplier: mistakeCount === 0 ? this.config.multipliers.perfection : 1.0,
      firstWinMultiplier: isFirstWinner ? this.config.multipliers.firstWin : 1.0,
      totalScore,
      breakdown
    };
  }
