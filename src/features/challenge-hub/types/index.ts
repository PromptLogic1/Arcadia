...
export interface UpdateChallengeFormData extends Partial<CreateChallengeFormData> {
  id: string
}
...
// Constants
export const DIFFICULTY_LEVELS: Record<DifficultyLevel, { label: string; color: string; points: number }> = {
