...
export function CommunityComponent() {
    ...
    return discussions
      .filter((discussion) => {
        ...
        const matchesChallenge =
          selectedChallenge === 'All Challenges' || discussion.challenge_type === selectedChallenge
  ...
  }, [discussions, debouncedSearchQuery, selectedGame, selectedChallenge, sortBy])
  ...
  const handleComment = (discussionId: number, commentData: {
    content: string
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 bg-gray-800/30 p-4 rounded-lg border border-gray-700/50">
              ...
              <div className="flex items-center space-x-4">
                <ToggleGroup
                  type="single"
                  value={sortBy}
                  onValueChange={(value: string) => setSortBy(value as 'newest' | 'hot')}
