...
export const MOCK_DISCUSSIONS: readonly Discussion[] = [
  {
    ...
    content: 'Looking for tips on defeating Malenia. I\'ve been struggling with her waterfowl dance attack. Any experienced players have advice on timing and positioning?',
    author_id: 'user_1',
    game: 'Elden Ring',
  ...
  },
  {
    ...
    content: 'What are your thoughts on the current building meta? The new update seems to have changed the flow significantly.',
    author_id: 'user_2',
    game: 'Fortnite',
  ...
  },
  {
    ...
    content: 'Looking for advice on leading raids effectively. How do you manage 20+ people and keep everyone focused?',
    author_id: 'user_3',
...
export const MOCK_EVENTS: StoreEvent[] = [
  {
    ...
    description: 'Join our monthly Fortnite tournament with cash prizes! Registration opens March 25th.',
  ...
  },
  {
    ...
    description: 'Test your speedrunning skills in our weekly community event. All skill levels welcome!',
