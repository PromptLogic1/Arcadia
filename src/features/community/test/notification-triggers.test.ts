...
describe('Notification Service', () => {
  ...
  describe('Notification Preferences', () => {
    it('should respect user notification preferences', async () => {
      ...
      expect(shouldSendNotification('comment_reply', user.preferences)).toBe(
        false
      );
    ...
    it('should respect quiet hours', async () => {
      ...
      expect(
        shouldSendNotification('comment_reply', user.preferences, {
    ...
    it('should always send critical notifications', async () => {
      ...
      expect(
        shouldSendNotification('account_security', user.preferences, {
          checkQuietHours: true,
          priority: 'critical',
        })
      ).toBe(true);
      ...
      expect(
        shouldSendNotification('content_removed', user.preferences, {
          checkQuietHours: true,
          priority: 'high',
        })
      ).toBe(true);
  ...
  describe('Notification Batching', () => {
    it('should batch similar notifications', async () => {
      ...
      const batched = await batchNotifications(
        notifications as ServiceNotification[]
      );
  ...
  describe('Notification Content Formatting', () => {
    ...
    it('should format moderation notifications', async () => {
      ...
      expect(content.body).toContain(
        'Your discussion "My Discussion" was removed'
      );
      expect(content.details).toContain('Reason: spam');
