...
describe('Search Service', () => {
  describe('Search Term Parsing', () => {
    ...
    it('should parse complex search queries', () => {
      const result = parseSearchTerms('"pokemon red" speedrun -glitch "world record"');
      expect(result.terms).toEqual(['speedrun']);
      ...
      const results: SearchResult[] = [
        {
          ...
          score: 0.5,
          highlights: { content: ['This has <mark>speedrun</mark> in the content'] },
        },
        {
          discussion: createMockDiscussion({ 
            id: 2, 
  ...
  describe('Filter Operations', () => {
    ...
    it('should filter discussions by challenge type', () => {
      ...
      const filtered = filterDiscussions(discussions, { challengeType: 'Bingo' });
      expect(filtered).toHaveLength(2);
    ...
    it('should filter discussions by multiple tags (AND operation)', () => {
      ...
      const filtered = filterDiscussions(discussions, { tags: ['strategy', 'tips'] });
    ...
    it('should combine multiple filters', () => {
      const discussions = [
        createMockDiscussion({ id: 1, game: 'Pokemon', challenge_type: 'Bingo', tags: ['strategy'] }),
        createMockDiscussion({ id: 2, game: 'Pokemon', challenge_type: 'Speedrun', tags: ['strategy'] }),
        createMockDiscussion({ id: 3, game: 'Sonic', challenge_type: 'Bingo', tags: ['strategy'] }),
      ];
  ...
  describe('Sort Operations', () => {
    it('should sort by newest first', () => {
      const discussions = [
        createMockDiscussion({ id: 1, created_at: new Date('2024-01-01').toISOString() }),
        createMockDiscussion({ id: 2, created_at: new Date('2024-01-03').toISOString() }),
        createMockDiscussion({ id: 3, created_at: new Date('2024-01-02').toISOString() }),
      ];
  ...
  describe('Search Performance', () => {
    ...
    it('should debounce search requests', async () => {
      ...
      const debouncedSearch = vi.fn(); // Mock debounced function
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle special regex characters in search', () => {
      ...
      const searches = ['[brackets]', '(parentheses)', '$100', '50%', 'user@email.com'];
