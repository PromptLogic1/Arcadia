...
// Server Component - no useMemo needed
const PartnersSectionServer = () => {
  return (
    <CyberpunkBackground
      variant="circuit"
      intensity="subtle"
    ...
    >
      {/* FloatingElements will be added client-side via a wrapper if needed */}
...
export default PartnersSectionServer;
