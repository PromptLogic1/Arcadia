...
// Server Component - no need for useMemo or React.memo
const UpcomingEventsSectionServer = () => {
  return (
    <CyberpunkBackground
      variant="circuit"
      intensity="medium"
    ...
    >
      {/* FloatingElements will be added client-side via wrapper */}
      <section
...
export default UpcomingEventsSectionServer;
