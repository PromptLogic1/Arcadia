...
interface ProgressEvent {
  type: 'game_completed' | 'achievement_progress' | 'milestone_reached' | 'streak_update';
  userId: string;
  timestamp: number;
...
export class ProgressTracker {
  ...
  trackGameCompletion(userId: string, gameData: {
    duration: number;
    won: boolean;
    gameType: string;
    score?: number;
    ...
    // Update win rate
    const totalWins = Math.round(progress.statistics.winRate * (progress.totalGamesPlayed - 1));
    const newWins = totalWins + (gameData.won ? 1 : 0);
    progress.statistics.winRate = newWins / progress.totalGamesPlayed;

    // Update average duration
    const totalDuration = progress.statistics.averageGameDuration * (progress.totalGamesPlayed - 1);
  ...
  calculateProgressVelocity(userId: string, days = 7): {
    ...
    // Get recent history
    const recentHistory = this.getProgressHistory(userId)
...
describe('Progress Tracker', () => {
  ...
  describe('Basic Progress Tracking', () => {
    ...
    test('should update win rate correctly', () => {
      tracker.trackGameCompletion('user-1', { duration: 600, won: true, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-1', { duration: 600, won: false, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-1', { duration: 600, won: true, gameType: 'puzzle' });
  ...
  describe('Achievement Progress', () => {
    test('should track achievement progress', () => {
      const result = tracker.updateAchievementProgress('user-1', 'speedrun-master', 50);
    ...
    test('should detect achievement completion', () => {
      ...
      const result = tracker.updateAchievementProgress('user-1', 'speedrun-master', 100);
  ...
  describe('Progress Analytics', () => {
    ...
    test('should calculate average game duration', () => {
      tracker.trackGameCompletion('user-1', { duration: 600, won: true, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-1', { duration: 900, won: true, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-1', { duration: 1200, won: true, gameType: 'puzzle' });
  ...
  describe('Leaderboards', () => {
    test('should generate leaderboard by total games', () => {
      ...
      tracker.trackGameCompletion('user-2', { duration: 600, won: true, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-2', { duration: 600, won: true, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-2', { duration: 600, won: true, gameType: 'puzzle' });
      
      tracker.trackGameCompletion('user-3', { duration: 600, won: true, gameType: 'puzzle' });
    ...
    test('should generate leaderboard by win rate', () => {
      ...
      tracker.trackGameCompletion('user-2', { duration: 600, won: true, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-2', { duration: 600, won: false, gameType: 'puzzle' });
      tracker.trackGameCompletion('user-2', { duration: 600, won: true, gameType: 'puzzle' });
