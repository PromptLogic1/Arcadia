        ...
        {stats.map((stat, index) => (
          ...
          >
            <Card className="border-cyan-500/20 bg-gray-800/50 transition-colors hover:border-cyan-500/40">
              <CardContent className="p-6">
                <div
                  className={`h-12 w-12 rounded-full bg-gradient-to-r ${stat.color} mb-4 flex items-center justify-center`}
                >
        ...
        <div className="rounded-lg bg-gray-800/50 p-1 backdrop-blur-sm">
          {['achievements', 'submissions'].map(tab => (
            <Button
              ...
              className={`px-6 capitalize transition-all duration-300 ${
                activeTab === tab
