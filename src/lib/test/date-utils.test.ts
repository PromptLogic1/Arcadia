...
describe('Date Utilities', () => {
  ...
  describe('Date utilities integration', () => {
    it('should work together for different use cases', () => {
      ...
      const dates = [
        { date: new Date('2024-01-15T11:59:30Z'), relative: 'just now', full: 'January 15, 2024' },
        { date: new Date('2024-01-15T10:00:00Z'), relative: '2h ago', full: 'January 15, 2024' },
        { date: new Date('2024-01-10T12:00:00Z'), relative: '5d ago', full: 'January 10, 2024' },
        { date: new Date('2023-12-01T12:00:00Z'), relative: 'December 1, 2023', full: 'December 1, 2023' },
      ];
