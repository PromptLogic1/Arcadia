  ...
  describe('Cache System', () => {
    describe('Cache Key Generation', () => {
      it('should generate consistent cache keys', () => {
        ...
        expect(userProfileKey).toMatch(
          /@arcadia\/cache:user-profile:user-123$/
        );
  ...
  describe('Rate Limiting System', () => {
    describe('Rate Limiting Service', () => {
      ...
      it('should check game session limits', async () => {
        const result =
          await rateLimitingService.checkGameSessionLimit('test-user');
      ...
      it('should check game action limits', async () => {
        const result =
          await rateLimitingService.checkGameActionLimit('test-user');
    ...
    describe('Identifier Generation', () => {
      it('should use user ID when available', () => {
        ...
        const identifier = rateLimitingService.getIdentifier(
          mockRequest,
          'user-123'
        );
    ...
    describe('Rate Limiting Middleware', () => {
      ...
      it('should handle different rate limit types', async () => {
        ...
        const authResult = await withRateLimit(
          mockRequest,
          mockHandler,
          'auth'
        );
        ...
        const gameResult = await withRateLimit(
          mockRequest,
          mockHandler,
          'gameAction'
        );
