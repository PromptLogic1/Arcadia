...
describe('cyberpunkStyles', () => {
  ...
  describe('neonGlow styles', () => {
    test('should contain cyan glow styles', () => {
      ...
      expect(cyanGlow).toContain(
        '[text-shadow:0_0_4px_theme(colors.cyan.400/70)]'
      );
    });
    ...
    test('should contain purple glow styles', () => {
      ...
      expect(purpleGlow).toContain(
        '[text-shadow:0_0_4px_theme(colors.purple.400/70)]'
      );
    });
    ...
    test('should contain fuchsia glow styles', () => {
      ...
      expect(fuchsiaGlow).toContain(
        '[text-shadow:0_0_4px_theme(colors.fuchsia.400/70)]'
      );
    });
    ...
    test('should contain emerald glow styles', () => {
      ...
      expect(emeraldGlow).toContain(
        '[text-shadow:0_0_4px_theme(colors.emerald.400/70)]'
      );
    });
    ...
    test('all neon glow variants should follow consistent pattern', () => {
      ...
      glowVariants.forEach(glowStyle => {
        ...
        expect(glowStyle).toMatch(
          /\[text-shadow:0_0_4px_theme\(colors\.\w+\.400\/70\)\]/
        );
      });
    });
  });
  ...
  describe('type safety', () => {
    ...
    test('neonGlow object should have all color variants', () => {
      ...
      expectedColors.forEach(color => {
        ...
        expect(
          typeof cyberpunkStyles.neonGlow[
            color as keyof typeof cyberpunkStyles.neonGlow
          ]
        ).toBe('string');
      });
    });
