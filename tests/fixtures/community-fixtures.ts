  ...
  const templates = [
    {
      ...
      content:
        "I've been working on improving my Bingo completion times. What are your favorite strategies for efficient square completion? Looking for tips on routing and time management.",
      game: 'Pokemon',
    ...
    },
    {
      ...
      content:
        "Sharing some advanced speedrun techniques I've discovered. These work particularly well for sub-2 hour runs. Would love to hear what techniques others are using.",
      game: 'Sonic',
    ...
    },
    {
      ...
      content:
        'Created a comprehensive guide for the most difficult achievements. These require specific setups and timing. Let me know if you need clarification on any steps.',
      game: 'Mario',
    ...
    },
    {
      ...
      content:
        "We're organizing a community tournament for next month. Multiple categories available. Registration closes in two weeks. Looking forward to seeing everyone compete!",
      game: 'Multi-Game',
...
export function generateCommentThread(
  ...
  parent: Omit<Comment, 'id' | 'created_at' | 'updated_at'>;
  replies: Array<Omit<Comment, 'id' | 'created_at' | 'updated_at'>>;
} {
  const parent = generateComment(discussion_id, {
    content:
      'This is a great discussion! I have some thoughts on this topic that might be helpful.',
    author_id: USER_SCENARIOS.regularUser.id,
  });
  ...
  const replies = Array.from({ length: replyCount }, (_, i) =>
    generateComment(discussion_id, {
      ...
      author_id:
        i % 2 === 0 ? USER_SCENARIOS.newUser.id : USER_SCENARIOS.regularUser.id,
    })
  );
...
export const MODERATION_TEST_CONTENT = {
  spam: {
    obvious: {
      ...
      content:
        'Visit our website at spam-gold-site.com for the cheapest game currency! Use code SPAM50 for 50% off! Limited time offer!!! Click now!!!',
      game: 'All Games',
    ...
    subtle: {
      ...
      content:
        'I created this amazing strategy guide. You can download it from my website. Just search for "advanced gaming strategies" and you\'ll find it. Hope it helps!',
      game: 'Pokemon',
      tags: ['guide', 'free'],
    },
    repetitive: {
      ...
      content:
        "Hey everyone! Come watch my stream at twitch.tv/mygamingchannel! I'm live right now! twitch.tv/mygamingchannel! Don't miss out! twitch.tv/mygamingchannel!",
      game: 'Sonic',
      tags: ['stream', 'live'],
    },
  },
  ...
  inappropriate: {
    harassment: {
      ...
      content:
        "This person is completely wrong and should stop posting. They clearly don't understand the game and are wasting everyone's time with their stupid questions.",
      game: 'Mario',
      tags: ['response'],
    },
    offensive: {
      ...
      content:
        'This content contains inappropriate language and offensive material that would violate community guidelines in a real scenario.',
      game: 'Pokemon',
      tags: ['guidelines'],
    },
    personal: {
      ...
      content:
        'I know where this user lives and I think we should all contact them directly to tell them how wrong they are about this strategy.',
      game: 'Sonic',
      tags: ['behavior'],
    },
  },
  ...
  copyright: {
    ...
    content:
      "Here is the complete text from the official strategy guide book. I'm copying it here word for word because I think everyone should have access to this copyrighted material.",
    game: 'Mario',
    tags: ['guide', 'strategy'],
  },
  ...
  offtopic: {
    ...
    content:
      "I know this isn't about gaming challenges, but I wanted to share my favorite pizza places near major gaming conventions. Let me know if you want the full list!",
    game: 'Off-topic',
 ...
 */
export function generateLargeDiscussionSet(
  count: number
): Array<Omit<Discussion, 'id' | 'created_at' | 'updated_at'>> {
  return Array.from({ length: count }, (_, i) => {
    ...
    if (!game || !challengeType)
      throw new Error('Failed to select game or challenge type');
  ...
  discussions: [
    {
      ...
      content:
        'Advanced shiny hunting strategies including chain methods and probability calculations.',
      game: 'Pokemon',
      challenge_type: 'Achievement Hunt',
    ...
    },
    {
      ...
      content:
        'Comprehensive guide to speed running techniques for completing challenges faster.',
      game: 'Sonic',
      challenge_type: 'Speedrun',
      tags: ['speed', 'any%', 'fast'],
    },
    {
      ...
      content:
        'Mathematical approach to optimal bingo square completion order and routing.',
      game: 'Mario',
      challenge_type: 'Bingo',
    ...
    },
    {
      ...
      content:
        'Detailed analysis of recent tournament results with statistical breakdowns.',
      game: 'Multi-Game',
      challenge_type: 'Tournament',
