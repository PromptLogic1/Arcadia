...
test.describe('404 and Error Page Handling', () => {
  test.describe('404 Page Functionality', () => {
    test('should display proper 404 page for non-existent routes', async ({ page }) => {
    ...
    test('should maintain navigation on 404 pages', async ({ page }) => {
      ...
      const homeLinks = page.locator('a[href="/"], a:has-text("Home"), a:has-text("Back to home")');
  ...
  test.describe('Dynamic Route 404s', () => {
    test('should handle 404s for dynamic routes with invalid IDs', async ({ page }) => {
    ...
    test('should differentiate between route not found and data not found', async ({ page }) => {
      // Route that exists but data doesn't
      await page.goto('/user/999999');
      
      // Might show "User not found" rather than "Page not found"
      const dataNotFound = page.locator('text="User not found", text="Data not found", text="Content not available"');
  ...
  test.describe('Error Page Content', () => {
    ...
    test('should handle internationalization on 404 pages', async ({ page }) => {
      ...
      for (const locale of locales) {
        ...
        const errorIndicators = page.locator('text="404", text="not found", text="no encontrado", text="pas trouvé"');
  ...
  test.describe('Error Recovery', () => {
    test('should allow recovery from 404 through navigation', async ({ page }) => {
