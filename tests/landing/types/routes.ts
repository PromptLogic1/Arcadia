...
export const ROUTE_CONFIG: Record<keyof typeof LANDING_ROUTES, RouteMetadata> = {
  home: {
    ...
    description: 'Experience the ultimate gaming community platform with challenges, competitions, and more.',
    requiresAuth: false,
  ...
  about: {
    ...
    description: 'Learn about Arcadia\'s mission to create the best gaming community platform.',
    requiresAuth: false,
    expectedStatusCode: 200,
    seoPriority: 0.8,
  ...
  features: {
    ...
    description: 'Explore all the features that make Arcadia the ultimate gaming platform.',
    requiresAuth: false,
    expectedStatusCode: 200,
    seoPriority: 0.9,
  ...
  pricing: {
    ...
    description: 'Find the perfect plan for your gaming needs with transparent pricing.',
    requiresAuth: false,
    expectedStatusCode: 200,
    seoPriority: 0.9,
    expectedLoadTime: 2000,
  ...
  blog: {
    ...
    description: 'Stay updated with the latest gaming news, tips, and community highlights.',
    requiresAuth: false,
    expectedStatusCode: 200,
    seoPriority: 0.7,
    expectedLoadTime: 2500,
